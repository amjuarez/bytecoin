...
const size_t   CRYPTONOTE_REWARD_BLOCKS_WINDOW               = 75;
...
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 700;
//TODO Define number of digits
const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 15;
...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 30 * 60 * 60 / DIFFICULTY_TARGET;
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        =  40 * 1024;
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_NUMERATOR         = 65 * 1024;
...
const char     CRYPTONOTE_NAME[]                             = "simplecoin";
