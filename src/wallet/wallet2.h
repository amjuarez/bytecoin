...
namespace tools
{
  ...
  public:
    ...
    void init(const std::string& daemon_address = "http://localhost:42080", uint64_t upper_transaction_size_limit = ((CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE * 125) / 100) - CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE);
