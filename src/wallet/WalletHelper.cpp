...
WalletHelper::IWalletRemoveObserverGuard::IWalletRemoveObserverGuard(CryptoNote::IWallet& wallet, CryptoNote::IWalletObserver& observer) :
  m_wallet(wallet),
  m_observer(observer),
  m_removed(false) {
...
void WalletHelper::storeWallet(CryptoNote::IWallet& wallet, const std::string& walletFilename) {
